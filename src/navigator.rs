...
impl Navigator {
    pub fn new(db: Rc<JiraHandle>) -> Self {
        Self {
...
mod tests {
    ...
    fn should_start_on_home_page() {
        ...
        let current_page = nav
            .get_current_page()
            .unwrap();
        let home_page_any = current_page.as_any();

        let home_page = home_page_any.downcast_ref::<HomePage>();
    ...
    fn handle_action_should_handle_create_epic() {
        ...
        nav.handle_action(Action::CreateEpic)
            .unwrap();
